...
1. Explain what a token is used for.
   Tokens are used to authenticate a user, each user has a specific token that ties into the information that they are submitting, once it matches up you have access to what content was behind that token.
2. What steps can you take in your web apps to keep your data secure?
   You can create a private route which is authenticated through a token. That way you only give access specific information to whomever has the token. Sensitive information should be excrypted and stored in an api.

3. Describe how web servers work.
   Web servers interact with users through a series of connections with other servers. The main function of a web server is to store process and deliver information to clients.
